<template>
  <section class="pt-10 pb-24 bg-primary-darkViolet text-neutral-veryLightgray lg:hidden">
    <img class="w-screen mx-auto sm:max-w-sm sm:mt-20" src="../assets/images/image-intro-mobile.jpg" alt="First Photo">
    <div class="relative pr-5 px-5 text-center mx-auto bg-pattern-intro-left sm:bg-none bg-left-top bg-no-repeat">
      <h1 class="font-dm-serif text-4xl pt-10">Humanizing your insurance.</h1>
